...
export const SURVEY: SurveyQuestion[] = [
  ...
  },
  {
    ...
    unit: "percent",
    feeds: ["ai-reception-pilot"],
    why: "Used only for a scenario. Missed callers may behave differently from answered callers.",
    min: 0,
    max: 100,
  },
  {
    id: "customerValue",
    prompt: "What is the average revenue from a new customer's first completed job?",
    unit: "usd",
    feeds: ["ai-reception-pilot"],
